...
**Start here:** [Installation](#installation) · [Usage](#usage) · [Troubleshooting](#troubleshooting) · [Upload to GitHub](GITHUB-UPLOAD.md)
...
![FrameDrop video mode on YouTube, with a 2160p source format selected](screenshots/video-mode.png)

### MP3 mode

Switch to audio-only output and choose 128, 192, or 320 kbps.

![FrameDrop MP3 mode on YouTube, with 320 kbps selected](screenshots/mp3-mode.png)

<details>
<summary><strong>View the available-quality selector</strong></summary>
<br>
<img src="screenshots/quality-selector.png" alt="FrameDrop quality menu showing source formats from 2160p downward" width="450">
...
Read [the GitHub upload guide](GITHUB-UPLOAD.md) for exact steps, a suggested repository description, and release packaging instructions. **Upload the extracted contents so `README.md` sits at the repository root.** Uploading only the ZIP as a repository file will not display this README or its screenshots.
